...
namespace EvolutionrayHarmonizationLibrary.Helpers
{
    ...
    {
        public static readonly string csvStatisticsHeader = "Seed; PopulationSize; TournamentSize; CrossoverProbability; MutationFractionProbability; BasicWorstTournamentParticipantProbability;" +
            "IterationNr; AbosluteMaxValue; IsBestCorrect; AbsoluteMean; AbsoluteStandardDeviation; CorrectPercentage\n";
        public static string CreateCsvString(this List<PopulationStatistics> statistics, int seed, int populationSize, int tournamentSize,
            double crossoverProbability, double mutationFractionProbability, double basicWorstTournamentParticipantProbability)
        {
            string csvString = "";
            string basicCsvString = $"{seed}; {populationSize}; {tournamentSize}; {crossoverProbability}; {mutationFractionProbability}; {basicWorstTournamentParticipantProbability}; ";
