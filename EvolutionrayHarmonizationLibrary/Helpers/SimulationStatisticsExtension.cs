...
namespace EvolutionrayHarmonizationLibrary.Helpers
{
    ...
    {
        public static readonly string csvStatisticsHeader = "Seed; PopulationSize; TournamentSize; EliteSize; CrossoverProbability; MutationFractionProbability; BasicWorstTournamentParticipantProbability;" +
            "IterationNr; AbosluteMaxValue; IsBestCorrect; AbsoluteMean; AbsoluteStandardDeviation; CorrectPercentage\n";
        public static string CreateCsvString(this List<PopulationStatistics> statistics, int seed, int populationSize, int tournamentSize, int eliteSize,
            double crossoverProbability, double mutationFractionProbability, double basicWorstTournamentParticipantProbability)
        {
            string csvString = "";
            string basicCsvString = $"{seed}; {populationSize}; {tournamentSize}; {eliteSize}; {crossoverProbability}; {mutationFractionProbability}; {basicWorstTournamentParticipantProbability}; ";
